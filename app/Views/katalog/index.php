        ...
        <div class="col-md-6 col-xl-4 pb-3 px-3">
          <div class="product-card">
            ...
            <div class="product-info">
              ...
              <div class="price">Rp <?= number_format($m->harga_jual, 0, ',', '.') ?></div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalLabel<?= $m->id_mobil ?>"><?= esc($m->nama_mobil) ?></h5>
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  <p><strong>Harga:</strong> Rp <?= number_format($m->harga_jual, 0, ',', '.') ?></p>
