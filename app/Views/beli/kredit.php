        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <a href="<?php echo base_url('beli/tambah_beli/')?>"><button class="btn btn-primary mt-2"><i class="fa-solid fa-plus"></i>
                            Tambah</button></a>
                    </div>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="table-beli">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Foto</th>
                        ...
                        <?php $no=1; foreach ($beli as $s) { ?>
                            <tr>
                                ...
                                <td>Rp <?= number_format($s->profit_credit, 0, ',', '.') ?></td>
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item text-warning" href="<?= base_url('beli/edit_beli/' . $s->id_sold) ?>">
                                                        <i class="fa-solid fa-pen-to-square me-1"></i> Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item text-danger" href="<?= base_url('beli/hapus_kredit/' . $s->id_sold) ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
