      ...
      <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
          ...
          <p class="text-subtitle text-muted">
            Jual Mobil : <?= esc($mobil->nama_mobil) ?> (<?= esc($mobil->plat_mobil) ?>)
          </p>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="harga_beli" class="form-control" value="Rp <?= number_format($mobil->harga_beli, 0, ',', '.') ?>" readonly>
                            </div>

                            <div class="mb-3">
                                <label for="harga_jual">Harga Jual</label>
                                <input type="text" name="harga_jual" id="harga_jual" class="form-control" value="Rp <?= number_format($mobil->harga_jual, 0, ',', '.') ?>" required>
                            </div>
                        </div>
                    </div>
